...
public class UpdateUtil {
   ...
   * @param update
   *          the SPARQL UPDATE query in text form
   * @param bindings
   *          optional bindings to set on the prepared query
  ...
  /**
   * Executes a SPARQL UPDATE (INSERT or DELETE) statement in a separate
   * transaction, i.e. the execution will be wrapped in connection.begin() /
   * connection.commit() block.
   *
   * @param repositoryConnection
   *          a connection to a repository
   * @param update
  ...
  public static void executeUpdateInTransaction(RepositoryConnection repositoryConnection, String update,
      Binding... bindings) throws MalformedQueryException, RepositoryException, UpdateExecutionException {
